...
public class artistpage extends Application {  
    ...
    public void start(Stage primaryStage) {
            ...
            { 
            	try{
                    ...
                    if(genre==null || genre.equals("Any"))
           	        ...
           	        new musiclibrary(rs,language,userID,"artist").start(primaryStage);
            	} 	catch (Exception w) {
        ...
        bio.setStyle("-fx-text-fill: #0000ff; -fx-font: 23px Serif");
        ...
        mysong.setMinSize(160,70); 
        GridPane.setConstraints(mysong,0,4);
        mysong.setStyle("-fx-text-fill: #0000ff; -fx-font: 23px Serif");
        ...
        payment.setMinSize(160,70); 
        GridPane.setConstraints(payment,0,6);
        payment.setStyle("-fx-text-fill: #0000ff; -fx-font: 23px Serif");
        ...
        addSong.setMinSize(160,70); 
        GridPane.setConstraints(addSong,0,8);
        ...
        out.setStyle("-fx-text-fill: #0000ff; -fx-font: 18px Serif"); 
        ...
        g2.getChildren().addAll(profile,bio,mysong,payment,addSong,out);
        HBox hBox=new HBox();
