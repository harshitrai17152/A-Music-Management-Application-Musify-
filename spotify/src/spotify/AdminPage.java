    ...
    public void start (final Stage primaryStage) { 
        ...
        EventHandler<ActionEvent> event1a = new EventHandler<ActionEvent>() { 
            ...
            { 
            	Connection con;
				try {
					con=DriverManager.getConnection("jdbc:mysql://localhost:3306/spo","root","Maeve@123");
        ...
        EventHandler<ActionEvent> event4 = new EventHandler<ActionEvent>() { 
            ...
            { 
				...
				try {
	        		...
	        		String query = "select a.ArtistID,a.UsersFollowing from"+innerCountQuery+ " having a.UsersFollowing = (select max(a.UsersFollowing) from " +innerCountQuery +");";
	        		System.out.println(query);
	        		ResultSet mostPlayedSong = sta.executeQuery(query);
	        		mostPlayedSong.next();
