...
public class loginfilm extends Application {
    ...
    public void start(Stage primaryStage) {
        primaryStage.setTitle("Login as a Film Maker");
        ...
        EventHandler<ActionEvent> event1 = new EventHandler<ActionEvent>() { 
            ...
            { 
            	try { 
                    ...
                    String q1= "select * from FilmMakers"; 
                    ...
                    while(rs.next()) 
                    {
                    	if(rs.getString(3).equals(username))
                    	{
                    		...
                    		if(!rs.getString(4).equals(password))
                    		{
                    			...
                    			new filmpage(rs.getInt(1)).start(primaryStage);
                    		break;
                    	}
                    }
                    if(!found)
                    {
                    	...
                    	alert.setTitle("Warning");
                    	alert.setHeaderText(null);
                    	alert.setContentText("Film Maker not found!");
                    	  alert.showAndWait();
                    }                 	
                } 	catch (Exception w) {
