...
//                    	mood = "any(select distint MoodName from Mood";	
        ...
        g2.setPadding(new Insets(100,60,0,80)); // top,right,bottom,left
        g2.setVgap(20);    
        g2.setHgap(20);   
        ...
        EventHandler<ActionEvent> event1=new EventHandler<ActionEvent>() { 
            ...
            { 
            	try
            	{
            		...
            		new UserProfile(userID).start(primaryStage);
        ...
        lastpl.setText("Recently Played");
        GridPane.setConstraints(lastpl,0,4);
        lastpl.setStyle("-fx-text-fill: #0000ff; -fx-font: 20px Serif");
        ...
        favsong.setText("Favourite Songs"); 
        GridPane.setConstraints(favsong,0,8);
        favsong.setStyle("-fx-text-fill: #0000ff; -fx-font: 20px Serif");
...
//        subs.setMinSize(200,70);
        GridPane.setConstraints(subs,0,12);
        subs.setStyle("-fx-text-fill: #0000ff; -fx-font: 17px Serif");
...
//        subs.setMinSize(200,70);
        ...
        g2.getChildren().addAll(profile,lastpl,favsong, subs, recommend);
        HBox hBox=new HBox();
        ...
        primaryStage.setTitle("Welcome to Musify!");
        primaryStage.show(); 
